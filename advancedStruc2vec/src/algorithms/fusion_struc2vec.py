...
class FusionStruc2Vec(BaseStruc2Vec):
    ...
    def __init__(self, graph, **kwargs):
        ...
        self.fusion_method = kwargs.get('fusion_method', 'weighted')  # fusion method
    ...
    def _get_or_generate_distance_files(self):
        ...
        if self.original_distance_file is None:
            ...
            if Path(temp_dist).exists():
                ...
                raise FileNotFoundError("无法Generating原始距离文件")
        
        # Graphlet 距离文件
        if self.graphlet_distance_file is None:
            print("📊 Generating Graphlet 结构距离...")
    ...
    def _fuse_distances(self, dist1_path, dist2_path, output_path):
        """融合两个距离文件"""
        print(f"🔗 融合距离文件 (method: {self.fusion_method}, α: {self.alpha})...")
        ...
        print(f"✅ 融合Completed: {output_path}")
        return output_path
    
    def train(self):
        """Training融合 Struc2Vec model"""
        print("🚀 Training融合 Struc2Vec...")
        ...
        print("✅ 融合 Struc2Vec TrainingCompleted")
